...
Namespace DAL
    Public Class RoomDA
        ...
        Public Shared Function IsAntiPassbackRoom(ByVal roomId As Integer) As Boolean
            Using dr As ExecuteReaderResult = DataCommand.Create().Param("Action", "IsPassback").Param("RoomID", roomId).ExecuteReader("dbo.Room_Select")
                If dr.Read() Then
        ...
        Public Shared Function GetAllActiveRooms() As DataTable
            Return DataCommand.Create.Param("Action", "ForEditing").FillDataTable("dbo.Room_Select")
        End Function
    End Class
End Namespace