...
Public Class ApportionmentDefaultOld
    Inherits UserPage
    ...
    Protected Sub BtnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Dim updates As Integer = DataCommand.Create().Update(dtApporDef, Sub(cfg)
    ...
    Private Function GetRooms(dt As DataTable) As IList(Of RoomApportionmentItem)
